...
まず起動の前に、処理したいファイルをflsフォルダーの中にすべて入れておいてください。  
...
CreateとAppendの場合ですが、どのオプションでも中身のみをすべて入れるような形にしてください。
Only modsを選ぶ場合は、modのみを入れる、のようなイメージです。
modとshaderpacksを同時に導入するときは、CreateをしてからAppendをする、のようにしてください。
